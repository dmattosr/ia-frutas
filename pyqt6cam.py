...
class MainWindow(QMainWindow):
    ...
    def image_saved(self, id, fileName):
        ...
        # Recorta imagen
        cmd1 = "convert '{filename}' -crop 700x700+155+107 '{filename}'".format(filename=fileName)
        cmd2 = "python testing.py '{filename}' 1".format(filename=fileName)
        os.system(cmd1)
        os.system(cmd2)
        # image_view = ImageView(self._current_preview, 'imagenes/test3.png')
